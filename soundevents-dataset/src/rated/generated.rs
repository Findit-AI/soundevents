...
const _: () = {
  ...
  impl ::core::convert::TryFrom<u64> for &'static RatedSoundEvent {
  ...
  impl ::core::convert::TryFrom<u64> for RatedSoundEvent {
    type Error = UnknownRatedSoundEventCode;
    #[cfg_attr(not(tarpaulin), inline(always))]
    fn try_from(value: u64) -> ::core::result::Result<Self, Self::Error> {
...
pub static DATASET: ::phf::Map<&'static UncasedStr, &'static [&'static super::RatedSoundEvent]> =
  ::phf::Map {
